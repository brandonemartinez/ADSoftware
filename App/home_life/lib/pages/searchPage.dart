...
class _SearchPageState extends State<SearchPage> {
  ...
  final AlertDialog _showDialog = AlertDialog(
    ...
    content: SizedBox(
      ...
      child: Column(
        children: const [
          Text('Hay mucha demanda de electricistas en Maldonado y no hay suficientes especailistas. Si eres electricista puedes agregar esta especialidad a los servicios que ofreces, o puedes recomendar a un electricista que conozcas que se descargue la app para atender la demanda.'),
        ],
      ),
    ),
    actions: [
