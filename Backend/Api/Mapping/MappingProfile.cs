    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<EspecialistaDto, Usuario>()
                ...
                .ForPath(dest => dest.Especialista.HoraDesde.Value.Hours, act => act.MapFrom(src => src.HoraDesde))
                .ForPath(dest => dest.Especialista.HoraHasta.Value.Hours, act => act.MapFrom(src => src.HoraHasta))
